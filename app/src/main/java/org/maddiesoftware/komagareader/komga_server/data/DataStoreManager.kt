package org.maddiesoftware.komagareader.komga_server.data
...
import org.maddiesoftware.komagareader.core.util.PREFS_STORE_NAME
import java.io.IOException
import javax.inject.Inject

class DataStoreManager @Inject constructor(@ApplicationContext private val context: Context) {

    private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(PREFS_STORE_NAME)
