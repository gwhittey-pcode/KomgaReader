...
class SeriesFromCollectionRemotePagingSource (private val api: KomgaServerApi, private val collectionId: String?, private val libraryId: String?):
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Series> {
        ...
        val response  = api.getSeriesFromCollection(collectionId = collectionId.toString(), page = currentPage,libraryId=libraryId)
